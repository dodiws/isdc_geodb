...
def getGeneralInfoVillagesCommon(village):
	# template = './generalInfo.html'
	# village = request.GET["v"]

	context_dict = getCommonVillageData(village)
	px = AfgLndcrva.objects.all().filter(vuid=village).values('agg_simplified_description').annotate(totalpop=Sum('area_population'), totalarea=Sum('area_sqm')).values('agg_simplified_description','totalpop', 'totalarea')
	data1 = {'columntitles':['Landcover','Population'],'child':[]}
	data2 = {'columntitles':['Landcover','Area'],'child':[]}
	for i in px:
		data1['child'].append([i['agg_simplified_description'],round(i['totalpop'] or 0,0)])
		data2['child'].append([i['agg_simplified_description'],round(i['totalarea']/1000000,1)])
...
def getDemographicInfoCommon(vuid):

	context_dict = getCommonVillageData(vuid)

	rowsgenderpercent = AfgPpltDemographics.objects.all().filter(vuidnear=vuid).values()
	...
	data['by_age_gender'] = {'columntitles':['Age','Male','Female']}
	if context_dict['vuid_population'] > 200:
		data['by_age_gender']['child'] = [
			['0-4',   -i['m_perc_yrs_0_4'],    i['f_perc_yrs_0_4']],
			['5-9',   -i['m_perc_yrs_5_9'],    i['f_perc_yrs_5_9']],
			['10-14', -i['m_perc_yrs_10_14'],  i['f_perc_yrs_10_14']],
			['15-19', -i['m_perc_yrs_15_19'],  i['f_perc_yrs_15_19']],
			['20-24', -i['m_perc_yrs_20_24'],  i['f_perc_yrs_20_24']],
			['25-29', -i['m_perc_yrs_25_29'],  i['f_perc_yrs_25_29']],
			['30-34', -i['m_perc_yrs_30_34'],  i['f_perc_yrs_30_34']],
			['35-39', -i['m_perc_yrs_35_39'],  i['f_perc_yrs_35_39']],
			['40-44', -i['m_perc_yrs_40_44'],  i['f_perc_yrs_40_44']],
			['45-49', -i['m_perc_yrs_45_49'],  i['f_perc_yrs_45_49']],
			['50-54', -i['m_perc_yrs_50_54'],  i['f_perc_yrs_50_54']],
			['55-59', -i['m_perc_yrs_55_59'],  i['f_perc_yrs_55_59']],
			['60-64', -i['m_perc_yrs_60_64'],  i['f_perc_yrs_60_64']],
			['65-69', -i['m_perc_yrs_65_69'],  i['f_perc_yrs_65_69']],
			['70-74', -i['m_perc_yrs_70_74'],  i['f_perc_yrs_70_74']],
			['75-79', -i['m_perc_yrs_75_79'],  i['f_perc_yrs_75_79']],
			['80+',   -i['m_perc_yrs_80pls'],  i['f_perc_yrs_80pls']],
		]
	else:
		data['by_age_gender']['child'] = [
			['0-9',   -i['m_perc_yrs_0_4']  -i['m_perc_yrs_5_9'],    i['f_perc_yrs_0_4']  +i['f_perc_yrs_5_9']],
			['10-19', -i['m_perc_yrs_10_14']-i['m_perc_yrs_15_19'],  i['f_perc_yrs_10_14']+i['f_perc_yrs_15_19']],
			['20-29', -i['m_perc_yrs_20_24']-i['m_perc_yrs_25_29'],  i['f_perc_yrs_20_24']+i['f_perc_yrs_25_29']],
			['30-39', -i['m_perc_yrs_30_34']-i['m_perc_yrs_35_39'],  i['f_perc_yrs_30_34']+i['f_perc_yrs_35_39']],
			['40-49', -i['m_perc_yrs_40_44']-i['m_perc_yrs_45_49'],  i['f_perc_yrs_40_44']+i['f_perc_yrs_45_49']],
			['50-59', -i['m_perc_yrs_50_54']-i['m_perc_yrs_55_59'],  i['f_perc_yrs_50_54']+i['f_perc_yrs_55_59']],
			['60-69', -i['m_perc_yrs_60_64']-i['m_perc_yrs_65_69'],  i['f_perc_yrs_60_64']+i['f_perc_yrs_65_69']],
			['70-79', -i['m_perc_yrs_70_74']-i['m_perc_yrs_75_79'],  i['f_perc_yrs_70_74']+i['f_perc_yrs_75_79']],
			['80+',   -i['m_perc_yrs_80pls'],                        i['f_perc_yrs_80pls']],
		]

	data['by_gender'] = {'columntitles':['Gender','Percent']}
	data['by_gender']['child'] = [
		['Male', i['vuid_male_perc']],
		['Female', i['vuid_female_perc']],
	]
...
class DemographicInfo(Resource):
	...
	def getdata(self, request, **kwargs):
		...
		data = getDemographicInfoCommon(request.GET.get('vuid'))
		response = {
			'panels_list':{
				'tables':[
					{
						'key':'base_info',
						'child':[
							[_('Settlement'),data['context']['name_en']],
							[_('Language'),data['context']['language_field']],
							[_('District'),data['context']['dist_na_en']],
							[_('Province'),data['context']['prov_na_en']],
							[_('Area'),data['context']['area_sqm']],
							[_('Total Population'),data['context']['area_population']],
							[_('Average Household Size'),data['context']['vuid_pop_per_building']],
							[_('Number of Buildings'),data['context']['area_buildings']],
						],
					},
				],
				'charts':[
					{
						'key':'gender_ratio_by_age_group',
						'title':_('Gender Ratio by Age Group (in %)'),
						'desc-x':_('in percent of total population'),
						'desc-y':_('age group in years'),
						'data':data['by_age_gender'],
					},
					{
						'key':'gender_ratio',
						'title':_('Gender Ratio (in %)'),
						'data':data['by_gender'],
					},
				]
			},
...
class GeneralInfoVillages(Resource):
	...
	def getdata(self, request, **kwargs):
		...
		data = getGeneralInfoVillagesCommon(request.GET.get('vuid'))
		response = {
			'panels_list':{
				'tables':[
					{
						...
						'child':[
							...
							[_('Elevation'),data['context']['elevation']],
							[_('Area'),data['context']['area_sqm']],
							[_('Total Population'),data['context']['area_population']],
							[_('Average Household Size'),data['context']['vuid_pop_per_building']],
							[_('Number of Buildings'),data['context']['area_buildings']],
							[_('Local Name'),data['context']['name_local']],
							[_('Local Name Confidence Level'),data['context']['name_local_confidence']],
							[_('Alternative English Name'),data['context']['name_alternative_en']],
							[_('Type of Settlement'),data['context']['type_settlement']],
						],
					},
				],
				'charts':[
					{
						'key':'number_of_population',
						'title':_('Number of Population'),
						'data':data['pop'],
					},
					{
						'key':'number_of_area',
						'title':_('Number of Area (km2)'),
						'data':data['area'],
					},
				]
			},
			'data':{
				'coordinate':{
					'lon':data['context']['longitude'],
					'lat':data['context']['latitude'],
				},
			},
		}
